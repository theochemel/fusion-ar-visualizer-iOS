// Written by epologee on GitHub
// https://gist.github.com/epologee/7373ea371812e8facd5a7a00e6b80d70#file-binary-stl-parser-swift
...
public enum BinarySTLParser {
    ...
    public static func createNodeFromSTL(withData data: Data,
                                         unit scale: UnitScale = .meter,
                                         correctFor3DPrint: Bool = true) throws -> SCNNode
    {
        let fileData = data
